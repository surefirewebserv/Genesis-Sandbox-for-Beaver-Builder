...
function genesis_sandbox_get_blank_template() {
	if (  is_singular() ){
		...
		if ($value_key == 'true'){
			...
			remove_action( 'genesis_footer'      , 'genesis_sandbox_add_third_nav', 5 ); 
...
add_action( 'wp', 'genesis_sandbox_get_blank_template' );
